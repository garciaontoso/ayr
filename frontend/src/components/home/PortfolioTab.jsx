      ...
      <div style={{display:"flex",flexDirection:"column",gap:6}}>
        ...
        {portfolioList.length>0 && (() => {
          ...
          <div style={{display:"flex",gap:12,padding:"6px 0",flexWrap:"wrap",alignItems:"center"}}>
            <div style={{fontFamily:"var(--fm)",display:"flex",alignItems:"center"}}
              title="Solo cuentas IBKR (4 cuentas). Tastytrade y T3 NO incluidos — ver tabs TT y P&L para totales por broker."><span style={{fontSize:9,color:"var(--text-tertiary)"}}>NLV </span><span style={{fontSize:20,fontWeight:700,color:"var(--text-primary)"}}>{hide("$"+fDol(nlv))}</span><span style={{fontSize:8,color:"var(--text-tertiary)",marginLeft:4,fontWeight:600,letterSpacing:.3}}>IB</span><TrustBadge level={isLive?"fresh":getLevel("nlv")} source={isLive?"IB OAuth (en vivo)":getSource("nlv")} updatedAt={isLive?(lastSync||getUpdatedAt("nlv")):getUpdatedAt("nlv")} note="Solo IBKR — TT/T3 separados"/></div>
